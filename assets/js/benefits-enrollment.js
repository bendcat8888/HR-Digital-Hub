const documents = [
    ...
    },
    {
        id: "benefits-faq",
        title: "Benefits FAQ",
        description: "Frequently asked questions and helpful contacts.",
        category: "Help",
        icon: "circle-help",
        url: "#",
        popularity: 70
...
const dom = {
    search: document.getElementById("benefits-search"),
    chips: document.getElementById("benefits-category-chips"),
    grid: document.getElementById("benefits-grid"),
    empty: document.getElementById("benefits-empty"),
    count: document.getElementById("benefits-count"),
    clear: document.getElementById("benefits-clear-filters"),
    sort: document.getElementById("benefits-sort-by"),
    toast: document.getElementById("benefits-toast"),
    toastText: document.getElementById("benefits-toast-text")
};
...
function renderGrid(items) {
    ...
    items.forEach((item) => {
        ...
        card.innerHTML = `
            <div class="mb-4">
                <div class="bg-rose-100 text-rose-700 w-12 h-12 rounded-xl flex items-center justify-center transition-transform group-hover:scale-110">
