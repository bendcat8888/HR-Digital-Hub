const documents = [
    {
        id: "handbook-master",
        title: "Employee Handbook (Master Copy)",
        description: "Core policies, benefits overview, and employee guidelines.",
        category: "Policies",
        icon: "book-open",
        url: "#",
        popularity: 95
    },
    {
        ...
        description: "Workplace standards, compliance, and expected behaviors.",
        category: "Policies",
        icon: "shield-check",
        url: "#",
        popularity: 90
    },
    {
        ...
        description: "Mission, vision, and culture references for everyone.",
        category: "Culture",
    ...
    {
        id: "it-security-guide",
        title: "IT Security Basics",
        description: "Password rules, phishing awareness, and access do’s and don’ts.",
        category: "Guides",
        icon: "lock",
        url: "#",
        popularity: 75
    },
    {
        ...
        description: "Safety reminders and basic workplace procedures.",
        category: "Guides",
        icon: "hard-hat",
        url: "#",
        popularity: 70
...
const dom = {
    search: document.getElementById("handbook-search"),
    chips: document.getElementById("handbook-category-chips"),
    grid: document.getElementById("handbook-grid"),
    empty: document.getElementById("handbook-empty"),
    count: document.getElementById("handbook-count"),
    clear: document.getElementById("handbook-clear-filters"),
    sort: document.getElementById("handbook-sort-by"),
    toast: document.getElementById("handbook-toast"),
    toastText: document.getElementById("handbook-toast-text")
};
...
function renderGrid(items) {
    ...
    items.forEach((item) => {
        ...
        card.innerHTML = `
            <div class="mb-4">
                <div class="bg-amber-100 text-amber-700 w-12 h-12 rounded-xl flex items-center justify-center transition-transform group-hover:scale-110">
